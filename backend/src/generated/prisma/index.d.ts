...
export namespace Prisma {
  ...
  */
  ...
  type PetGetPayload<S extends boolean | null | undefined | PetDefaultArgs> =
    $Result.GetResult<Prisma.$PetPayload, S>;
  ...
  > {
    ...
    updateManyAndReturn<T extends PetUpdateManyAndReturnArgs>(
      args: SelectSubset<T, PetUpdateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$PetPayload<ExtArgs>,
        T,
    ...
    aggregate<T extends PetAggregateArgs>(
      args: Subset<T, PetAggregateArgs>
    ...
    >(
      args: SubsetIntersection<T, PetGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
      ? GetPetGroupByPayload<T>
  ...
  export type PetScalarFieldEnum =
    (typeof PetScalarFieldEnum)[keyof typeof PetScalarFieldEnum];
  ...
  export type PetScalarWhereWithAggregatesInput = {
    ...
    birthDate?:
      | DateTimeNullableWithAggregatesFilter<'Pet'>
      | Date
      | string
      | null;
